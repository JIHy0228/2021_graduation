...
public class Pharmacy extends AppCompatActivity { // 약국조회
    TextView text;
    XmlPullParser xpp;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.actvity_pharmacy);
    ...
    String getXmlPharmacy(){
        ...
        String Q1 = URLEncoder.encode(str);// 주소 검색
        String queryUrl="http://apis.data.go.kr/B552657/ErmctInsttInfoInqireService/getParmacyListInfoInqire?servicekey="+key
                +"&numOfRows=100&Q0="+Q1;
        try{
